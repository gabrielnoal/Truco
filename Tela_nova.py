...
#            print (event)
            ...
            if apertou_ESPAÇO == True:
                if jogo.jogador == 0:
                    ...
                    tela_truco.blit(botao_correr_0,[(posição_botao_truco_0[0] + 145), posição_botao_truco_0[1]])
                    ...
                    tela_truco.blit(botao_correr_1,[(posição_botao_truco_1[0] - 145), posição_botao_truco_1[1]])
